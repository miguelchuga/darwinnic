...
class DocumentoAsociado(models.Model):
    ...
    factura_id = fields.Many2one('account.move', string='Documento', domain=[('type','=','in_invoice')])
...
class LineaPoliza(models.Model):
    ...
    documentos_ids = fields.Many2many('account.move', string='Facuras', domain=[('type','=','in_invoice')])
